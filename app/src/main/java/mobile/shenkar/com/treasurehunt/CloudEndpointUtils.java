...
public class CloudEndpointUtils {
   ...
   * for more information.
   */
    public static final String REMOTE_APP_ENGINE_SERVER_URL_FOR_ANDROID = "https://absolute-shell-96315.appspot.com";
    ...
    public static <B extends AbstractGoogleClient.Builder> B updateBuilder(
        ...
        if (LOCAL_ANDROID_RUN) {
            ...
            builder.setRootUrl(REMOTE_APP_ENGINE_SERVER_URL_FOR_ANDROID
                    + "/_ah/api");
        }

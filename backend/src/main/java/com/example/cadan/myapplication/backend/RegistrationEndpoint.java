...
import static com.example.cadan.myapplication.backend.OfyService.ofy;
...
public class RegistrationEndpoint {
     ...
     * @param regId The Google Cloud Messaging registration Id to add
     */
    @ApiMethod(name = "registerMyDevice",path = "registerMyDevice/{regId}")
    public void registerMyDevice(@Named("regId") String regId) {
        if(findRecord(regId) != null) {
            log.info("Device " + regId + " already registered, skipping register");
            return;
        }
